  ...
  return (
    <>
      <main className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Link
          to={"/"}
          className="text-yellow-300 hover:text-yellow-300 flex items-center mb-6 font-medium transition text-lg group:"
        >
        ...
        <div className="bg-gray-900 p-6 md:p-12 rounded-3xl shadow-2xl shadow-black/70 border border-gray-800">
          <div className=" lg:flex lg:space-x-12">
            <div className="lg:w-1/2 mb-8 lg:mb-0">
              ...
              <img
                ...
                alt
                className="w-[400px] h-[400px] rounded-xl shadow-2xl shadow-black/50 object-cover border border-gray-800 ring-2 ring-blue-400"
              ></img>
            </div>
            <div className="lg:w-1/2 bg-gray-800 rounded-xl shadow-inner shadow-black/30 border border-gray-700 pb-3">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 list-none p-0">
                {ingredients.map((item, index) => (
                  ...
                  >
                    <span className="text-blue-400 font-extrabold  text-lg mr-2 shrink-0 ml-2">
                      {">"}
                    </span>
              ...
              <div className="mt-8 pt-4 border-t border-gray-700">
                <div className="text-lg text-gray-400 space-x-3 flex flex-wrap gap-y-2">
                  <span className="bg-blue-600 text-white space-x-3 px-4 py-1.5 rounded-full font-semibold shadow-md ml-3 ">
                    {meal.strCategory}
                  </span>
                  <span className="bg-green-400 text-white space-x-3 px-4 py-1.5 rounded-full font-semibold shadow-md ml-3 ">
                    {meal.strArea}
                  </span>
                </div>
              </div>
          ...
          {/* instructions */}
          <div className="mt-14 pt-8 border border-gray-800"> </div>
          <h2 className=" text-3xl font-bold text-gray-400 flex items-center mb-8 mt-4">
            <BookOpen className="w-7 h-7 mr-3 text-blue-500" />

            Detailed Preparations Steps
          </h2>
          <ol className="space-y-6 list-none text-gray-300 ">
            {instructions.map((step, index) => (
              <li
                key={index}
                className="text-lg leading-relaxed bg-gray-800 p-5 rounded-xl border-1-6 border-blue-500 shadow-lg shadow-black-30 duration-300 hover:bg-gray-700/50 border border-l-15"
              >
...
export default RecipeDeatilsview;
